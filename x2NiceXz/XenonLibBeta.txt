do
	local ui = game:GetService("CoreGui"):FindFirstChild("XENONLIB")
	if ui then
		ui:Destroy()
	end
end
...
local PresetColor = Color3.fromRGB(255, 57, 196)
...
function Flux:Window(text, bottom, mainclr, toclose)
	...
	PresetColor = mainclr or Color3.fromRGB(255, 57, 196)
	local fs = false
	...
	function Flux:Notification(desc, buttontitle)
		...
		CloseBtn.BackgroundColor3 = Color3.fromRGB(41, 41, 41)
	...
	function Tabs:Tab(text, ico)
		...
		function ContainerContent:Button(text, desc, callback)
			...
			CircleSmall.BackgroundColor3 = Color3.fromRGB(41, 41, 41)
		...
		function ContainerContent:Colorpicker(text, preset, callback)
			...
			Colorpicker.BackgroundColor3 = Color3.fromRGB(41, 41, 41)
			...
			Confirm.BackgroundColor3 = Color3.fromRGB(41, 41, 41)
		...
		function ContainerContent:Line()
			...
			Line.BackgroundColor3 = Color3.fromRGB(41, 41, 41)
